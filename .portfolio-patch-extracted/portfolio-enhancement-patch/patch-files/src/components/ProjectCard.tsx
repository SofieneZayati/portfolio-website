...
export default function ProjectCard({ project, index }: Props) {
  ...
  const openProject = () => navigate(detailPath)
  ...
  return (
    ...
    >
      <div
        ...
        className="block relative overflow-hidden rounded-3xl border border-white/[0.06] bg-white/[0.02] transition-all duration-500 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-[#00f5ff]/60"
        style={{
